...
export default function InvitePage() {
  ...
  const canJoin = Boolean(code) && Boolean(discordUrl);
  ...
  return (
    <main style={{ padding: 24, maxWidth: 720, margin: "0 auto" }}>
      ...
      <h2 style={{ fontSize: 16 }}>動作確認</h2>
      <p style={{ marginTop: 8 }}>
        ローカル確認：{" "}
        <code>http://localhost:3000/invite?code=TESTCODE</code>
      </p>
      <p style={{ marginTop: 8 }}>
        メールから来る場合：この code は Sheet の <b>invite_code</b> と一致します。
      </p>
    </main>
  );
}
